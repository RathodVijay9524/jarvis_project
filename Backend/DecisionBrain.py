...
-> Respond with 'automation ( query )' if the query is asking to perform any task or automation like opening apps, creating files, controlling system, calendar/schedule management, email operations, etc. like if the query is 'open facebook and instagram.' respond with 'automation open facebook and instagram.', if the query is 'Remind me when it's 10 PM.' respond with 'automation Remind me when it's 10 PM.', if the query is 'Write a song for me.' respond with 'automation Write a song for me.', if the query is 'Generate an image of tony stark.' respond with 'automation Generate an image of tony stark.', if the query is 'open notepad' respond with 'automation open notepad', if the query is 'create a file' respond with 'automation create a file', if the query is 'close all windows' respond with 'automation close all windows', if the query is 'send email' respond with 'automation send email', if the query is 'read my emails' respond with 'automation read my emails', if the query is 'unread emails' respond with 'automation unread emails', if the query is 'check inbox' respond with 'automation check inbox', if the query is 'show my calendar' respond with 'automation show my calendar', if the query is 'what events do I have' respond with 'automation what events do I have', if the query is 'show my schedule for tomorrow' respond with 'automation show my schedule for tomorrow', if the query is 'what reminders do I have' respond with 'automation what reminders do I have'
...
"""
    ...
    def _fallback_classification(self, query: str) -> str:
        ...
        automation_keywords = [
            ...
            'create', 'make', 'write', 'generate', 'send', 'email', 'mail',
            'read', 'unread', 'inbox', 'check',
